...
8.1 La limite de joueur sur une scène criminelle est de 12 personnes. Il est cependant permis de dépasser cette limite lors d’une attaque contre votre QG. L'alliance entre gang afin de dépasser cette limite est strictement interdite (Référence du règlement 10.1)
